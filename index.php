...
<body>
	...
	<div class="navbar-wrapper">
		<div class="navbar  navbar-static-top " role="navigation">
			<a
				href="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.francisxavier.ac.in%2Ffaculties&psig=AOvVaw2t3_u8v7q5zKP-vzs-OFi0&ust=1680242123203000&source=images&cd=vfe&ved=0CA8QjRxqFwoTCMCJvej7gv4CFQAAAAAdAAAAABAE"><img
					style="padding-left: 10px;padding-top: 5px; height:100px;" src="images/logo.png" align="left"></a>
			...
			<div class="navbar navbar-inverse nomar">
				...
				<div class="navbar-collapse collapse nomar">
					<ul class="nav navbar-nav">
						...
						<li><a href=<?php if (isset($_SESSION['customer_email'])) {
						    echo "'logout.php'";
						} else {
	...
	<div class="navbar navbar-inverse navbar-static-top " role="navigation">
		<a href="full_menu.php">
			<h2 align="center" style="color: white">SPECIALS</h2>
		</a>
	</div>
	<div class="row">
	...
	<div class="navbar navbar-inverse navbar-static-top " role="navigation">
		<a href="full_menu.php">
			<h2 class="itemsTitle" style=" color: white" align="center">BREAKFAST</h2>
		</a>
	</div>
	...
	<p align="center"><a class="btn btn-success btn-lg" href="full_menu.php" role="button">&nbsp;&nbsp;&nbsp; View FULL
			MENU &nbsp;&nbsp;&nbsp;</a></p>
	<!--Lunch Carousel-->
	<div class="navbar navbar-inverse navbar-static-top " role="navigation">
		<a href="full_menu.php">
			<h2 class="itemsTitle" style="color: white" align="center">LUNCH</h2>
		</a>
	</div>
